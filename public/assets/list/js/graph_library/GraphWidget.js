  ...
  function updateDisplay(graphState, duration){
    ...
    try{
	  ...
	  if(currentIteration == lastIteration) {
		  pause(); //in html file
		  $('#play img').attr('src','../assets/list/img/replay.png').attr('alt','replay').attr('title','replay');
	  } else {
		  $('#play img').attr('src','../assets/list/img/play.png').attr('alt','play').attr('title','play');
	  }
    } catch(error){
