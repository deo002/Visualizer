...
$( document ).ready(function() {
	...
	if(surpriseColour == "#fec515" || surpriseColour == '#a7d41e') {
		...
		$('.tutorial-next img').attr("src", "../assets/list/img/arrow_black_right.png");
	}
	...
	if(colourTheSecond == '#fec515' || colourTheSecond == '#a7d41e') {
		...
		$('#actions-hide img').attr('src', '../assets/list/img/arrow_black_right.png');
	}
	...
	if(colourTheThird == '#fec515' || colourTheThird == '#a7d41e') {
		...
		$('#codetrace-hide img').attr('src', '../assets/list/img/arrow_black_right.png');
	...
	if(colourTheFourth == '#fec515' || colourTheFourth == '#a7d41e') {
		...
		$('#status-hide img').attr('src', '../assets/list/img/arrow_black_right.png');
	}
	...
	$('#mode-menu a').click(function() {
		...
		$('#mode-button').html(newMode + '<img src="../assets/list/img/arrow_white.png"/>');
